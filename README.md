...
Want to add your server to the Paw Network? You can apply to join by visiting our official Discord server: [Join the Paw Network Hub](https://discord.gg/sgU7EKuf8J)
...
- git clone \<https://github.com/EmersedFox/paw-network.git>
...
- **Go to the Developer Portal:** Navigate to the [Discord Developer Portal](https://www.google.com/search?q=https://discord.com/developers/applications).
